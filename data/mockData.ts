...
export const MOCK_WEBSHOP_PRODUCTS: WebshopProduct[] = [
  ...
  },
  {
    ...
    slug: 'meerpuntsluiting-skg-2100mm',
    description: 'Professionele meerpuntsluiting met SKG*** certificering. Biedt maximale bescherming tegen inbraak. Geschikt voor houten en kunststof deuren. Compleet met montage-instructies.',
    shortDescription: 'SKG*** gecertificeerde meerpuntsluiting voor maximale veiligheid',
    sku: 'MPL-2100-SKG3',
    price: 189.00,
    ...
    status: 'active',
    visibility: 'public',
    tags: ['meerpuntsluiting', 'skg', 'beveiliging', 'voordeur'],
    shippingRequired: true,
    weight: 3500,
    dimensions: { length: 2100, width: 150, height: 50 },
    taxClass: 'standard',
    requireShipping: true,
    digitalProduct: false,
    allowReviews: true,
  ...
  {
    id: 'wp3',
    name: 'Deurgreep RVS Gebogen 300mm',
    slug: 'deurgreep-rvs-gebogen-300mm',
    description: 'Moderne deurgreep van roestvrij staal met elegante gebogen vormgeving. Mat geborstelde afwerking voor een stijlvolle uitstraling. Eenvoudig te monteren op binnen- en buitendeuren.',
    shortDescription: 'Moderne gebogen deurgreep van RVS, 300mm',
    sku: 'DGR-300-RVS',
    price: 24.50,
    costPrice: 14.00,
    stockQuantity: 67,
    ...
    status: 'active',
    visibility: 'public',
    tags: ['deurgreep', 'rvs', 'deurtechniek', 'modern'],
    shippingRequired: true,
    weight: 450,
  ...
  {
    id: 'wp4',
    name: 'Veiligheidscilinder Anti-Kerntrek 35/35mm',
    slug: 'veiligheidscilinder-anti-kerntrek-35-35mm',
    description: 'Premium veiligheidscilinder met anti-kerntrek, anti-boor en anti-pick bescherming. Voorzien van 5 sleutels waarvan 1 service sleutel. Geschikt voor hoge beveiligingseisen.',
    shortDescription: 'Premium veiligheidscilinder met anti-kerntrek bescherming',
    sku: 'VCL-35-35-AK',
    price: 67.95,
    ...
    status: 'active',
    visibility: 'public',
    tags: ['veiligheidscilinder', 'anti-kerntrek', 'beveiliging', 'premium'],
    shippingRequired: true,
    weight: 350,
    taxClass: 'standard',
    requireShipping: true,
  ...
  {
    id: 'wp5',
    name: 'Deurdranger Hydraulisch Wit',
    slug: 'deurdranger-hydraulisch-wit',
    description: 'Hydraulische deurdranger met verstelbare sluitsnelheid en eindslag. Geschikt voor binnendeuren tot 80kg. Wit gelakte afwerking voor neutrale uitstraling. Eenvoudige montage.',
    shortDescription: 'Hydraulische deurdranger met verstelbare sluitsnelheid',
    sku: 'DDR-HYD-WIT',
    price: 45.00,
    costPrice: 28.00,
    stockQuantity: 34,
    ...
    status: 'active',
    visibility: 'public',
    tags: ['deurdranger', 'hydraulisch', 'deurtechniek', 'wit'],
    shippingRequired: true,
    weight: 1200,
    dimensions: { length: 200, width: 60, height: 50 },
    taxClass: 'standard',
    requireShipping: true,
    digitalProduct: false,
    allowReviews: true,
  ...
  {
    id: 'wp6',
    name: 'Profielcilinder Nikkel 30/40mm',
    slug: 'profielcilinder-nikkel-30-40mm',
    description: 'Asymmetrische profielcilinder van nikkel voor deuren met diepere kastmaat. Voorzien van 3 sleutels. Geschikt voor standaard beveiligingseisen.',
    shortDescription: 'Asymmetrische nikkel profielcilinder 30/40mm',
    sku: 'CIL-30-40-NK',
    price: 28.75,
    costPrice: 16.50,
    stockQuantity: 3,
    ...
    status: 'active',
    visibility: 'public',
    tags: ['cilinder', 'nikkel', 'asymmetrisch'],
    shippingRequired: true,
    weight: 180,
    taxClass: 'standard',
    requireShipping: true,
    ...
    badges: [
      { type: 'lowstock', priority: 4 },
    ],
  },
  {
    id: 'wp7',
    name: 'Deurbeslag Set Roestvrij Staal',
    slug: 'deurbeslag-set-rvs',
    description: 'Complete deurbeslag set bestaande uit 2 deurklinken op schild met rozetten. Roestvrij staal met mat geborstelde afwerking. Inclusief montage materiaal.',
    shortDescription: 'Complete RVS deurbeslag set met klinken op schild',
    sku: 'DBS-SET-RVS',
    price: 54.95,
    costPrice: 32.00,
    stockQuantity: 19,
    ...
    status: 'active',
    visibility: 'public',
    tags: ['deurbeslag', 'set', 'rvs', 'deurtechniek'],
    shippingRequired: true,
    weight: 850,
    taxClass: 'standard',
    requireShipping: true,
  ...
  },
  {
    ...
    description: 'Robuust hangslot van gehard staal met weerbestendige coating. Ideaal voor buitengebruik zoals schuren, poorten en fietsen. Voorzien van 2 sleutels.',
    shortDescription: 'Weerbestendig hangslot van gehard staal, 50mm',
    sku: 'HSL-50-WEER',
    price: 16.95,
    costPrice: 9.50,
    stockQuantity: 87,
    ...
    status: 'active',
    visibility: 'public',
    tags: ['hangslot', 'weerbestendig', 'beveiliging', 'buiten'],
    shippingRequired: true,
    weight: 320,
    taxClass: 'standard',
    requireShipping: true,
