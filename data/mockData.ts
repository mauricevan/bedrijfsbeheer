...
export const MOCK_INVENTORY: InventoryItem[] = [
  { id: '1', name: 'Staal plaat', sku: 'STL-001', quantity: 150, reorderLevel: 50, supplier: 'Staal B.V.', location: 'A1', price: 45.50, unit: 'stuk' },
  { id: '2', name: 'Aluminium staaf', sku: 'ALU-002', quantity: 80, reorderLevel: 30, supplier: 'MetaalGigant', location: 'A2', price: 28.75, unit: 'meter' },
  { id: '3', name: 'Schroeven M8', sku: 'SCH-003', quantity: 5000, reorderLevel: 1000, supplier: 'Bouten & Co', location: 'B1', price: 0.15, unit: 'stuk' },
  { id: '4', name: 'Verfspuit', sku: 'VRF-004', quantity: 12, reorderLevel: 5, supplier: 'Verf Wereld', location: 'C1', price: 245.00, unit: 'stuk' },
  { id: '5', name: 'Lasstaaf', sku: 'LAS-005', quantity: 200, reorderLevel: 50, supplier: 'Las Totaal', location: 'A3', price: 3.25, unit: 'stuk' },
];
